...
export class AddContactComponent implements OnInit {
  ...
  //    console.log('Submitted contact:', this.contactForm!.value);
  //    // Tutaj można dodać kod do dodania kontaktu do listy.
  //  }
  //}
...
////  categoryChange() {
////    this.addNewSubcategory = this.contactForm.value.category.categoryName == 'Inny';
////    this.updateCurrentCategorySubcategories();
////  }
...
////  addSubcategory(newSubcategoryName: string) {
////    let newSubcategory: SubcategoryToSave = {
////      id: 0,
